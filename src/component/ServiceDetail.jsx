      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Wondering how we help our clients? Take a look at our team's
              process.
            </p>
          </div>
                  ...
                  <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        We initiate the process by effective collaboration to
                        gain a deep understanding of your business objectives,
                        target audience, and project requirements and then focus
                        on building a strategic roadmap.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        Based on the planning and discovery, our skilled
                        designers work on wireframes and prototypes to visualize
                        the final website, incorporating the brand identity and
                        user experience principles. Our expert web developers
                        bring the design to life, utilizing clean coding
                        practices, responsive frameworks, and robust backend
                        systems to deliver a high-performing website.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        Our skilled team conducts rigorous testing to identify
                        and resolve any potential issues. Through meticulous
                        optimization, we aim to deliver optimal
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        We provide end-to-end support during the deployment
                        phase, ensuring a smooth and seamless launch of your web
                        application. Great remains
                      </p>
                    </div>
                  </div>
                </div>
